...
if [ "$os" = "Darwin" ]; then
    ...
    stow -D ghostty zed alacritty wallpaper git nvim ohmyposh tmux vim custom-vs-code vscode-linux zsh-linux
    stow  ghostty zed wallpaper git ohmyposh vim custom-vs-code vscode-linux zsh-linux
    fi
