...
vim.opt.completeopt = "menu,menuone,noselect" -- IDE friendly completion options
...
vim.keymap.set("n", "<C-)>", function()
    require("nvim-tree.api").tree.change_root_to_nodev()
...
vim.lsp.config("zls", {}) -- Configured zig language server
